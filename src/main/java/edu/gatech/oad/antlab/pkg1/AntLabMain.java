 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Samuel Chen");
		  toPrint += p1.toString("schen643");
		  ...
		  Person3 p3 = new Person3("Noah Le");
		  toPrint += p3.toString("noah3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Jimmy Pham");
                  toPrint += p4.toString("jpham35");
 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Hang Qiu");
		  toPrint += p2.toString("hqiu41");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Noah Le");
		  toPrint += p3.toString("noah3");
